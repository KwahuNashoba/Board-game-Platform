...
//============================================================================================================
class BoardGame_Plugin : public IVisPlugin_cl
{
public:
...
void BoardGame_Plugin::OnInitEnginePlugin()
{
  hkvLog::Info("BoardGame_Plugin:OnInitEnginePlugin()");
  Vision::RegisterModule(&g_BoardGameModule);
...
// load plugins if supported
  ...
  pManager->RegisterModule ( &g_BoardGameModule );
  ...
  pManager->Print( "This module is called '%s'", g_BoardGameModule.GetName() );
...
void BoardGame_Plugin::OnDeInitEnginePlugin()
{
  hkvLog::Info("BoardGame_Plugin:OnDeInitEnginePlugin()");
  ...
  VActionManager * pManager = Vision::GetActionManager ();
  pManager->UnregisterModule( &g_BoardGameModule );

  // de-register our module when the plugin is de-initialized
  Vision::UnregisterModule(&g_BoardGameModule);
}
